...
use crate::domain::nome_cliente::NomeCliente;
...
impl Cliente {
    ...
    pub fn register(nome: NomeCliente, documento: Cpf, email: Email) -> Self {
        Self {
            id: ClienteId::new(),
            nome,
            documento,
    ...
    pub fn reconstitute(id: ClienteId, nome: NomeCliente, documento: Cpf, email: Email) -> Self {
        Self {
            id,
            nome,
            documento,
    ...
    pub fn with_updated_data(&self, nome: NomeCliente, documento: Cpf, email: Email) -> Self {
        Self {
            id: self.id,
            nome,
            documento,
