...
use cadastro_api::application::delete_pedido::DeletePedido;
use cadastro_api::application::delete_produto::DeleteProduto;
...
use cadastro_api::application::get_pedido::GetPedido;
use cadastro_api::application::get_produto::GetProduto;
use cadastro_api::application::list_clientes::ListClientes;
use cadastro_api::application::list_pedidos::ListPedidos;
use cadastro_api::application::list_produtos::ListProdutos;
use cadastro_api::application::register_cliente::RegisterCliente;
use cadastro_api::application::register_pedido::RegisterPedido;
use cadastro_api::application::register_produto::RegisterProduto;
...
use cadastro_api::application::update_produto::UpdateProduto;
...
use cadastro_api::infra::audit_log_replayer::AuditLogReplayer;
use cadastro_api::infra::audited_cliente_repository::AuditedClienteRepository;
use cadastro_api::infra::audited_pedido_repository::AuditedPedidoRepository;
use cadastro_api::infra::audited_produto_repository::AuditedProdutoRepository;
...
use cadastro_api::infra::cache_pedido_repository::CachePedidoRepository;
use cadastro_api::infra::cache_produto_repository::CacheProdutoRepository;
