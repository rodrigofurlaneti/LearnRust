...
use crate::presentation::cliente::cliente_handlers;
use crate::presentation::pedido::pedido_handlers;
use crate::presentation::produto::produto_handlers;
use crate::presentation::shared::error_response::ErrorBody;
use crate::presentation::usuario::{auth_handlers, user_handlers};
...
/// pub use em cada mod.rs de agregado reexporta a funcao, mas nao o item
