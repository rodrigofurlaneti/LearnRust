...
impl ApiError {
    ...
    fn status_for_domain_error(domain_error: &DomainError) -> (StatusCode, String) {
        let status = match domain_error {
            ...
            | DomainError::InvalidNome
            | DomainError::InvalidDocument
            | DomainError::InvalidId
            | DomainError::ValorMonetarioInvalido
            | DomainError::InvalidQuantidade
            | DomainError::PedidoSemItens => StatusCode::BAD_REQUEST,
            DomainError::UserAlreadyExists
            | DomainError::ClienteAlreadyExists
            | DomainError::ProdutoAlreadyExists
            | DomainError::PedidoAlreadyExists => StatusCode::CONFLICT,
            DomainError::InvalidCredentials => StatusCode::UNAUTHORIZED,
            DomainError::PermissionDenied => StatusCode::FORBIDDEN,
            DomainError::UserNotFound
            | DomainError::ClienteNotFound
            | DomainError::ProdutoNotFound
            | DomainError::PedidoNotFound => StatusCode::NOT_FOUND,
        };
