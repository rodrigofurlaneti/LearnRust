...
use crate::presentation::{
    admin_ping, create_cliente, create_pedido, create_produto, delete_cliente, delete_pedido,
    delete_produto, delete_user, get_cliente, get_pedido, get_produto, list_clientes,
    list_pedidos, list_produtos, login, me, register, update_cliente, update_produto, update_user,
};
use crate::presentation::shared::openapi::ApiDoc;
...
pub fn build_router(state: AppState) -> Router {
    ...
    let produto_routes = Router::new()
        .route("/produtos", post(create_produto).get(list_produtos))
        .route(
            "/produtos/:id",
    ...
    let pedido_routes = Router::new()
        .route("/pedidos", post(create_pedido).get(list_pedidos))
        .route("/pedidos/:id", get(get_pedido).delete(delete_pedido));
