...
// Nenhuma regra de negocio mora aqui (SRP). Herdado sem alteracoes de
// comportamento da Semana 9 - so mudou o que ha "por baixo" do AppState
// (cache + auditoria em vez de Postgres/SQLite).
#[utoipa::path(
    post,
    path = "/auth/register",
    tag = "auth",
