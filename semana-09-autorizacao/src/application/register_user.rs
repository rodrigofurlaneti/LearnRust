...
/// Depende so de abstracoes do dominio (DIP), nunca de Postgres/bcrypt
/// diretamente. Sempre cria o usuario com o papel padrao (`User::register`
/// nunca aceita `Role` como parametro) - ver comentario em `domain/user.rs`.
